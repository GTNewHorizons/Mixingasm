...
public class TransformerInclusions {
    ...
    /**
     * Returns Mixingasm's dynamic transformer inclusion list. Add transformer name patterns to this list if you want to
     * spare them from being added to the mixin environment's transformer exclusion list, for example if you need to mix
     * into a version of a class that has been transformed by them. <br>
     * <br>
